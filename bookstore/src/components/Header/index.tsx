    ...
    <nav className="navbar border-bottom mb-3">
      <div className="container-fluid">
        ...
        <div className="navbar-nav flex-row align-items-center">
          <NavLink className="nav-link px-2" aria-current="page" to="/books/new">New Books</NavLink>
          ...
          <form className="d-flex align-items-center ms-3" role="search" onSubmit={handleSubmit}>
            <input type="search" className="form-control me-1" placeholder='Book title' style={{ width: '200px' }} onChange={handleChangeSearch} value={search} />
